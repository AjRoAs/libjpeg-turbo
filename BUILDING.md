...
or settings. In the sections below, _{build_directory}_ refers to the binary
directory, whereas _{source_directory}_ refers to the libjpeg-turbo source
...
This will generate the following files under _{build_directory}_:
...
By default, _{version}_ is 62.2.0, 7.2.0, or 8.1.2, depending on whether
libjpeg v6b (default), v7, or v8 emulation is enabled. If using Cygwin,
_{version}_ is 62, 7, or 8.
...
The following files will be generated under _{build_directory}_:
...
_{version}_ is 62, 7, or 8, depending on whether libjpeg v6b (default), v7, or
...
_{configuration}_ is Debug, Release, RelWithDebInfo, or MinSizeRel, depending
on the configuration you built in the IDE, and _{version}_ is 62, 7, or 8,
...
Create a file called **toolchain.cmake** under _{build_directory}_, with the
following contents:
...
_{mingw_binary_path}_ is the directory under which the MinGW binaries are
...
_{install_path}_ is the path under which the libjpeg-turbo binaries should be
installed.
...
The installer package (libjpeg-turbo-_{version}_[-gcc|-vc][64].exe) will be
located under _{build_directory}_. If building using the Visual Studio IDE,
then the installer package will be located in a subdirectory with the same name
as the configuration you built (such as _{build_directory}_\Debug\ or
_{build_directory}_\Release\).
