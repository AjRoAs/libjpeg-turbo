...
!(function (t) {
    ...
    ((y.cleanData =
        ...
        (y.widget.extend = function (t) {
            for (
                var e, i, s = a.call(arguments, 1), n = 0, o = s.length;
                n < o;
                n++
            )
                for (e in s[n])
            ...
            option: function (t, e) {
                ...
                if ("string" == typeof t)
                    if (
                        ...
                        for (
                            s = o[t] = y.widget.extend({}, this.options[t]),
                                n = 0;
                            n < i.length - 1;
                            n++
                        )
            ...
            flip: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        h = -2 * e.offset[0];
                    a < 0
                        ? ((s = t.left + l + i + h + e.collisionWidth - n - s) <
                              0 ||
                              s < D(a)) &&
                          (t.left += l + i + h)
                        : 0 < r &&
                ...
                top: function (t, e) {
                    var i = e.within,
                        ...
                        h = -2 * e.offset[1];
                    a < 0
                        ? ((s = t.top + l + i + h + e.collisionHeight - n - s) <
                              0 ||
                              s < D(a)) &&
                          (t.top += l + i + h)
                        : 0 < r &&
...
(function (root, factory) {
    ...
    $.powerTip = {
        ...
        hide: function apiCloseTip(element, immediate) {
            ...
            if (element) {
                displayController = $(element)
                    .first()
                    .data(DATA_DISPLAYCONTROLLER);
            } else if (session.activeHover) {
                displayController = session.activeHover.data(
                    DATA_DISPLAYCONTROLLER
                );
            }
        ...
        function computePlacementCoords(
            ...
            switch (placement) {
                case "n":
                    ...
                    coords.set(
                        "bottom",
                        session.windowHeight - position.top + offset
                    );
                    break;
                case "e":
                ...
                case "w":
                    ...
                    coords.set(
                        "right",
                        session.windowWidth - position.left + offset
                    );
                    break;
                case "nw":
                    coords.set(
                    ...
                    coords.set(
                        "right",
                        session.windowWidth - position.left - 20
                    );
                    break;
                case "nw-alt":
    ...
    function TooltipController(options) {
            ...
            if (
                ...
                (session.isTipOpen ||
                    (session.tipOpenImminent &&
                        tipElement.data(DATA_HASMOUSEMOVE)))
            ) {
                ...
                if (collisions !== Collision.none) {
                    ...
                    if (collisionCount === 1) {
                        ...
                        coords.set(
                            "left",
                            session.currentX - tipWidth - options.offset
                        );
                        coords.set(
                            "top",
                            session.currentY - tipHeight - options.offset
                        );
                    }
                }
                tipElement.css(coords);
        ...
        function positionTipOnElement(element) {
            ...
            if (
                ...
                priorityList =
                    $.fn.powerTip.smartPlacementLists[options.placement];
            ...
            var isDesynced = false,
                hasDesyncableCloseEvent =
                    $.grep(
                        ...
                        function (eventType) {
                            return (
                                $.inArray(eventType, options.closeEvents) !== -1
                            );
                        }
                    ).length > 0;
            if (
