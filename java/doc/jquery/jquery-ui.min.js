                ...
                return (
                    t
                        ? this.length || "instance" !== i
                            ...
                            : (n = void 0)
                        : (s.length &&
                              (i = x.widget.extend.apply(null, [i].concat(s))),
                          this.each(function () {
                              var t = x.data(this, l);
                              t
            ...
            option: function (t, e) {
                ...
                if ("string" == typeof t)
                    if (
                        ...
                        for (
                            s = o[t] = x.widget.extend({}, this.options[t]),
                                n = 0;
                            n < i.length - 1;
                            n++
                        )
        ...
        (x.ui.position = {
            fit: {
                left: function (t, e) {
                    ...
                    e.collisionWidth > n
                        ? 0 < l && a <= 0
                            ? ((i = t.left + l + e.collisionWidth - n - s),
                              (t.left += l - i))
                            : (t.left =
                                  !(0 < a && l <= 0) && a < l
                ...
                top: function (t, e) {
                    ...
                    e.collisionHeight > n
                        ? 0 < l && a <= 0
                            ? ((i = t.top + l + e.collisionHeight - n - s),
                              (t.top += l - i))
                            : (t.top =
                                  !(0 < a && l <= 0) && a < l
            ...
            flip: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        l = -2 * e.offset[0];
                    a < 0
                        ? ((s = t.left + u + i + l + e.collisionWidth - n - s) <
                              0 ||
                              s < E(a)) &&
                          (t.left += u + i + l)
                        : 0 < r &&
                ...
                top: function (t, e) {
                    var i = e.within,
                        ...
                        l = -2 * e.offset[1];
                    a < 0
                        ? ((s = t.top + u + i + l + e.collisionHeight - n - s) <
                              0 ||
                              s < E(a)) &&
                          (t.top += u + i + l)
                        : 0 < r &&
        ...
        x.widget("ui.menu", {
            ...
            _scrollIntoView: function (t) {
                ...
                this._hasScroll() &&
                    ((i =
                        parseFloat(
                            x.css(this.activeMenu[0], "borderTopWidth")
                        ) || 0),
                    (s =
                        parseFloat(x.css(this.activeMenu[0], "paddingTop")) ||
                        0),
            ...
            select: function (t) {
                this.active =
                    this.active || x(t.target).closest(".ui-menu-item");
    ...
    (x.widget("ui.autocomplete", {
        ...
        _suggest: function (t) {
            ...
            (this._renderMenu(e, t),
                ...
                this._resizeMenu(),
                e.position(
                    x.extend({ of: this.element }, this.options.position)
                ),
